...
The \texttt{MapPanel} class extends the \texttt{java.swing.JPanel} class and functions as a panel with added functionality and with an overridden \texttt{paint} method.
