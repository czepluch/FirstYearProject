...
\subsection{Outline}
\include*{Design_choices/outline}
...
\label{sec:Trie.class}
\include*{Implementation/trie_class}
...
\subsection{Outline}
\include*{Implementation/outline}
...
\include*{Implementation/condition_of_the_trie}
...
\subsection{Overall}
\include*{Reflection/overall}

\subsection{Outline}
\include*{Reflection/outline}
...
\begin{tabular}{ p{1cm} | p{4cm} | p{3cm} | p{2.5cm} }
	...
	A2 & ! Odense & odense\#\# & ? \\
	A3 & +Odense 9/? & odense\#\# & ? \\
	A4 & Ødense æå by üäÖ & ødense æå by üäö\#\# & ? \\
	A5 & Odense-By & odense-by\#\# & ? \\
	A6 & Odense' den fine by & odense' den fine by\#\# & ? \\
	B1 & 1234 & \#1234\# & ? \\
	B2 & ,!1234 & \#1234\# & ? \\
	B3 & ??1234  ) & \#1234\# & ? \\
	B4 & -1234 & -\#1234\# & ? \\
	B5 & 12 & null & ? \\
	B6 & 123456 & null & ? \\
	C1 & 8765 kØGe & køge\#8765\# & ? \\
	C2 & =?8765 kØGe & køge\#8765\# & ? \\
	C3 & 8765 kØGe=? & køge\#8765\# & ? \\
	C4 & køge 8765 & køge\#8765\# & ? \\
	C5 & køge,?=!8765 & køge\#8765\# & ? \\
	D1 & Skive, vejen, 4567 & skive\#4567\#vejen & ? \\
	D2 & Skive, vejen4567 & skive\#4567\#vejen & ? \\
	D3 & Skive,vejen 4567 & skive\#4567\#vejen & ? \\
	E1 & Rådby9876allegade & rådby\#9876\#allegade & ? \\
	E2 & Rådby 9876 allegade & rådby\#9876\#allegade & ? \\
	E3 & Rådby?=+" +?3?9876 allegade & rådby\#9876\#allegade & ? \\
	F1 & malmö Vegen 95667 & malmö vegen\#95667\# & ? \\
	F2 & malmö,Vegen,95667 & malmö\#95667\#vegen & ? \\
	G1 & københavn, roskilde, ålbæk & null & ? \\
	H1 & brøndby-øster +12+3 03+1 9,!?Nygade & brøndby-øster\#\#nygade & ? \\
	I1 & 1234 56789 & null & ? \\
	I2 & 1234,56789 & null & ? \\
	J1 & !?23++ & null & ? \\
	J2 & "\textit{empty}" & null & ?
