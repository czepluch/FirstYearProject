...
\subsection{Connecting the graphical user interface and the TernaryTrie with the Model for searching for trips and locations}
...
\label{sec:AddressParser class test}
...
\include*{Testing/gvertex_and_vertex_classes_test}
...
\include*{Testing/ternary_trie_test_class}
...
\include*{Testing/testing_the_graphical_user_interface}
...
For the testing of both of the following methods, the values of the \texttt{ViewValues} class, which are used, are set to the following:
\begin{itemize}
	\item minX = 20
	\item maxX = 120
	\item minY = 30
...
The \texttt{Vertex} class has the \texttt{distance} method, which has been blackbox tested according to the following expectancy table: \\ \\
\begin{tabular}{ p{3.5cm} | p{4cm} | p{2.5cm} | p{1cm} }
	...
	Low numbers & (0.58171, 0.93432),\newline(-0.18852, 0.43019) & 0.9205 & $\surd$ \\
...
\include*{Appendices/Project_diary/sunday_13_5_12}

\pagebreak
\subsection{Sunday, 13/5-2012 - Evening}
\include*{Appendices/Project_diary/sunday_13_5_12_evening
}
\pagebreak
\subsection{Monday, 14/5-2012}
\include*{Appendices/Project_diary/monday_14_5_12}

\pagebreak
\subsection{Friday, 18/5-2012}
\include*{Appendices/Project_diary/friday_18_5_12}

\pagebreak
\subsection{Sunday, 20/5-2012}
\include*{Appendices/Project_diary/sunday_20_5_12}

\pagebreak
\subsection{Monday, 21/5-2012}
\include*{Appendices/Project_diary/monday_21_5_12}

\pagebreak
\section{Work sheets made on Monday, 17/4-2012}
\include*{Appendices/Work_sheets/work_sheets}
...
Three UML diagrams can be found on the DVD:
\begin{itemize}
	\item A UML diagram of the connection between the Model, View and Controller classes
	\item A UML diagram of the Model package
	\item A UML diagram of the View package
\end{itemize}
